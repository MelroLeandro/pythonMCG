...
class ApplicationWindow(wx.Frame):
    ...
    def __init__(self,*args,**keywords):
        ...
        self.mcg_process = MCGprocess.MCGProcess()
        self.mcg_process.start()
        self.mcg_queue = self.mcg_process.mcg_queue
        ...
        self.mcg_widget = MCGwidget.MCGWidget(self.splitter,
                                                       self.mcg_queue)
        ...
        self.shell = \
            shelltoprocess.Shell(self.bottom_sizer_panel,
                                 queue_pack=self.mcg_process.queue_pack)
        ...
        self.splitter.SplitHorizontally(self.mcg_widget,
    ...
    def init_help_screen(self):
        ...
        self.help_images_list=[["Page 1", from_resource_folder("help1.png")],
                               ["Page 2", from_resource_folder("help2.png")],
                               ["Page 3", from_resource_folder("help3.png")],
                               ["Page 4", from_resource_folder("help4.png")]]
        ...
        for page in self.help_pages:
            self.help_notebook.AddPage(page, page.caption)
    ...
    def init_about_dialog_info(self):
        ...
        description="""\
An educational environment for learning Maths for CG.

Runs on Python 2.7, using wxPython, Psyco and py2exe. Thanks go to the developers
responsible for these projects, as well as to the helpful folks at the user groups
of project pythonturtle, and at StackOverflow.com."""

        info.SetCopyright("MIT License, (C) 2012 Ram Rachum (\"cool-RR\") and Carlos Leandro")
        info.SetDescription(description)
        info.SetName("PythonMCG")
        info.SetVersion("0.0.2012")
...
def run():
    ...
    app = wx.App()
    my_app_win = ApplicationWindow(None,-1,"PythonMCG",size=(600,600))
    app.MainLoop()
